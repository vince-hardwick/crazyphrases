...
- **Remaining risk**: Test and production promotion plus post-promotion smokes remain pending explicit owner approval or the documented workflow gates. Future notification cadence or scheduled persistence of `status = 'expired'` is separate scope.
