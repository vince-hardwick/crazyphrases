...
- **Next action**: Choose the next explicit signed-in 2-player asynchronous Game slice, with turn storage and turn submission the most likely next vertical slice. Keep invite expiry, creator cancellation UI, Reveal, Share Consent, friends, nudges, public discovery, broader profile/account UI, and broader social work out of that slice unless the owner explicitly expands scope.
