...
- **Next action**: Build the next handle-invite Pending Game slice only after deciding the next narrow lifecycle boundary. Keep public sharing, Share Consent, friends, nudges, public discovery, broader social profile work, invite acceptance, turn completion, and Reveal out of the next slice unless the owner expands scope.
