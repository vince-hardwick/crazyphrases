...
- **Remaining risk**: Hosted migration application, deployment promotion, and deployed smoke remain pending explicit owner approval or the documented workflow gates. Future notification cadence or scheduled persistence of `status = 'expired'` is separate scope.
