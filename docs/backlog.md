...
| Multiplayer and social graph | Nudge timeout foundation deployed to dev; most social scope deferred | Signed-in 2-player asynchronous game; Pending invite expiry duration; One-way following; Friend relationships; Manual pokes; Android app and push notifications |
