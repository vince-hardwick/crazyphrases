...
- **Deferred post-MVP crop UX**: Issue #79 tracks replacing the MVP numerical crop controls with a visual crop tool with guidelines and direct manipulation. This was deferred on 2026-06-25 because the derived-image storage contract and file upload/crop/save path are accepted for MVP, while the preferred visual cropper would expand scope after promotion.
