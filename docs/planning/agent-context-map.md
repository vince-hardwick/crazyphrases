...
| Uploaded Avatar storage | `docs/decisions/0019-uploaded-avatar-storage-authority.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/backlog.md` section `Uploaded Avatars` |
