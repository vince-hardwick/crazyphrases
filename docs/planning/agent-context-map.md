...
| Signed-in route gate for anonymous visitors | `docs/backlog.md` section `Signed-in route gate for anonymous visitors`, `docs/product-rules.md` section `Route model and account gates`; completed GitHub PRD issue #104 and completed implementation issues #105-#108 |
| Account Profile, lookup directory, and Gamer Tag | `docs/decisions/0023-private-email-lookup-and-gamer-tag.md`, historical `docs/decisions/0011-account-profile-handle-directory.md`, `docs/product-rules.md` |
...
| Uploaded Avatar storage | `docs/decisions/0019-uploaded-avatar-storage-authority.md`, `docs/decisions/0025-original-uploaded-avatar-cover-fit.md`, historical `docs/decisions/0021-derived-cropped-images-for-uploaded-avatars.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/backlog.md` section `Uploaded Avatars` |
...
| Pending Game foundation and lifecycle slices | `docs/backlog.md` section `Signed-in 2-player asynchronous game`, `docs/product-rules.md`, `docs/decisions/0023-private-email-lookup-and-gamer-tag.md`, `docs/decisions/0026-pending-game-invite-notification-authority.md`, historical `docs/decisions/0011-account-profile-handle-directory.md`, `docs/decisions/0012-pending-game-invite-response-authority.md`, `docs/decisions/0013-pending-game-start-conversion-authority.md`, `docs/decisions/0016-creator-controlled-multiplayer-cancellation.md`, `docs/decisions/0017-pending-game-invite-expiry.md`, `docs/decisions/0018-dashboard-triggered-nudge-generation.md`, `docs/runbooks/supabase-auth-and-postgres.md` |
| Game-scoped Multiplayer Game Play Surface | `docs/decisions/0027-game-scoped-multiplayer-play-surface.md`, `docs/product-rules.md`, `docs/backlog.md`; GitHub PRD issue #226 and child issues #227-#232 |
| Notification top-bar affordance and read-state hardening | `docs/backlog.md` sections `Notification top-bar affordance` and `Notification bulk read management`, `docs/product-rules.md` sections `Notifications` and `Notification delivery`; completed GitHub issue #97 for bell-affordance implementation evidence, #123 for empty-state copy, and PRD #127 / child issues #128-#132 for read-state hardening |
...
| Production Word Bank assets and build pipeline | `assets/word-bank/manifest.json`, `assets/word-bank/shards/`, `tools/word-bank/`, `docs/decisions/0024-versioned-static-word-bank-shards.md` |
| Local Word Bank review workbench startup, scheduled task, lock recovery, and maintenance | `docs/runbooks/word-bank-review-workbench.md`, `docs/decisions/0024-versioned-static-word-bank-shards.md` |
...
| Autonomous docs-only pull-request self-review and merge | `docs/decisions/0028-autonomous-docs-only-pr-merge.md`, `docs/runbooks/cloudflare-dns-and-access.md` |
...
| Documentation governance audits | `docs/planning/documentation-governance-*.md` |
