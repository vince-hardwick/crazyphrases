...
| `plans/2026-06-16-durable-account-profile-handle-directory.md` | Historical/completed. Do not execute as an active plan. | Current identity authority: `docs/decisions/0023-private-email-lookup-and-gamer-tag.md`; historical implementation provenance: `docs/decisions/0011-account-profile-handle-directory.md`, `docs/runbooks/supabase-auth-and-postgres.md`, GitHub issue #43 and child issues |
| `plans/2026-06-16-pending-game-foundation.md` | Historical/completed. Do not execute as an active plan. | `docs/backlog.md` section `Signed-in 2-player asynchronous game`, `docs/product-rules.md`, ADR 0023, `docs/runbooks/supabase-auth-and-postgres.md` |
...
| `plans/2026-07-02-private-lookup-hosted-reset-migration.md` | Historical/completed. Hosted reset, private lookup migration, legacy identity RPC cleanup, physical legacy column cleanup, PR merges, promotions, production smoke, source correction PR #157, and branch cleanup are complete. Do not execute as an active plan. | Current identity authority: ADR 0023, `docs/product-rules.md`, `docs/backlog.md`; hosted evidence: `docs/planning/supabase-state-ledger.md`; operational procedure: `docs/runbooks/supabase-auth-and-postgres.md`, `docs/runbooks/cloudflare-dns-and-access.md`; implementation provenance: PRs #152, #154, #156, #157 and issue #151 |
| `plans/2026-07-04-word-bank-source-research.md` | Historical/completed. The candidate source research has been executed; do not resume this as an active plan. | `docs/research/word-bank-sources.md`; `docs/backlog.md` sections `Expanded word-bank source selection`, `Word-bank family-friendly setting`, and `Production word-bank delivery` |
...
| `plans/2026-07-09-participant-scoped-started-game-loader.md` | Historical/completed source implementation at `ed5e0f4`; hosted migration `20260710065313`, PR #236 merge `ca03c62`, and separately approved `dev`, `test`, and production deployment/smoke are complete. Do not treat this plan as authority for future deployment or browser smoke. | GitHub issue #228, ADRs 0015, 0016, and 0027, `docs/product-rules.md`, `docs/planning/supabase-state-ledger.md`, `docs/runbooks/supabase-auth-and-postgres.md`, and `docs/runbooks/cloudflare-dns-and-access.md` |
| `plans/2026-07-12-multiplayer-entry-assist.md` | Source implementation, hosted migration verification, and Task 6 Steps 1-6 are complete. Development workflow run `29240601750` deployed source head `901ca431fd87808a902316674465689795926170`; the visible two-Account smoke and bounded cleanup passed. Recording the evidence changes the branch head, so final-head `dev` redeployment, merge, promotion, and closeout remain approval-gated. Do not rerun Tasks 1-5 or Task 6 Steps 1-6. | GitHub issue #230, ADRs 0024 and 0027, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/planning/supabase-state-ledger.md`; resume Task 6 at Step 7 by committing and verifying the evidence, pushing the new head, and obtaining a fresh approved `dev` deployment for that exact head. |
...
| `specs/2026-06-16-durable-account-profile-handle-directory-prd.md` | Published PRD provenance. Durable profile, MVP profile-management, avatar-upload personalisation, circular crop derivatives, and visual cropper UX are historical complete slices. Current Uploaded Avatar storage/rendering is governed by ADR 0025. | Current identity authority: ADR 0023; current avatar authority: ADR 0025; historical implementation provenance: GitHub issues #43, #47, #63, #64, #79, and #188; ADRs 0011, 0019, 0020, and 0021; `docs/backlog.md` |
...
| `specs/2026-07-12-multiplayer-entry-assist-design.md` | Implemented in source with the hosted migration, development deployment, visible two-Account functional smoke, and bounded cleanup verified for source head `901ca431fd87808a902316674465689795926170`. The evidence commit creates a new branch head, so final-head `dev` redeployment, merge, promotion, and closeout remain pending. | GitHub issue #230, ADRs 0024 and 0027, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/planning/supabase-state-ledger.md` |
