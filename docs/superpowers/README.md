...
| `specs/2026-06-16-durable-account-profile-handle-directory-prd.md` | Published PRD provenance. Durable profile, MVP profile-management, avatar-upload personalisation, circular crop derivatives, and visual cropper UX are complete. | Current identity authority: ADR 0023; historical implementation provenance: GitHub issues #43, #47, #63, #64, and #79; ADRs 0011, 0019, 0020, and 0021; `docs/backlog.md` |
