...
| `plans/2026-06-18-participant-section-multiplayer-foundation.md` | Historical/source-controlled complete. Do not execute as an active source plan; PR #57 is deployed to `dev`, but hosted migration application and signed-in multiplayer smoke remain pending explicit owner approval. | ADR 0015, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/planning/supabase-state-ledger.md`, `docs/backlog.md` |
...
| `specs/2026-06-18-multiplayer-execution-redesign.md` | Approved design provenance. Source-controlled participant-section foundation is complete; PR #57 is deployed to `dev`, but hosted migration application and signed-in multiplayer smoke remain pending explicit owner approval. | ADR 0015, `docs/product-rules.md`, `docs/backlog.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/planning/supabase-state-ledger.md` |
