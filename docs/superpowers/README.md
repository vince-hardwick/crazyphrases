...
| `plans/2026-07-12-multiplayer-entry-assist.md` | Source implementation and hosted migration verification complete. Task 6 Steps 1-3 are complete; final-head `dev` deployment, runtime smoke, cleanup, merge, promotion, and closeout remain approval-gated. Do not rerun Tasks 1-5 or Task 6 Steps 1-3. | GitHub issue #230, ADRs 0024 and 0027, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/planning/supabase-state-ledger.md`; resume Task 6 at Step 4 after explicit approval. |
...
| `specs/2026-07-12-multiplayer-entry-assist-design.md` | Implemented in source with the hosted migration applied and verified. Final-head deployment, functional smoke, cleanup, promotion, and closeout remain pending; runtime UI completion is not yet established. | GitHub issue #230, ADRs 0024 and 0027, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/planning/supabase-state-ledger.md` |
