...
| `plans/2026-07-09-participant-scoped-started-game-loader.md` | Historical/completed source implementation at `ed5e0f4`; hosted migration `20260710065313` was applied after separate approval. Do not treat this plan as authority for deployment or browser smoke. | GitHub issue #228, ADRs 0015, 0016, and 0027, `docs/product-rules.md`, `docs/planning/supabase-state-ledger.md`, `docs/runbooks/supabase-auth-and-postgres.md`, and `docs/runbooks/cloudflare-dns-and-access.md` |
