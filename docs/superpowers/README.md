...
| `plans/2026-07-12-multiplayer-entry-assist.md` | Active approved implementation plan for issue #230; execution has not started. | GitHub issue #230, `specs/2026-07-12-multiplayer-entry-assist-design.md`, ADRs 0024 and 0027, `docs/product-rules.md` |
