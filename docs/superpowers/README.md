...
| `plans/2026-07-12-multiplayer-entry-assist.md` | Source implementation complete; hosted validation and closeout remain approval-gated. Do not rerun Tasks 1-5. | GitHub issue #230, ADRs 0024 and 0027, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/planning/supabase-state-ledger.md`; resume only Task 6 after explicit approvals. |
...
| `specs/2026-07-12-multiplayer-entry-assist-design.md` | Implemented in source; hosted migration, deployment, functional smoke, promotion, and closeout remain pending. | GitHub issue #230, ADRs 0024 and 0027, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/planning/supabase-state-ledger.md` |
