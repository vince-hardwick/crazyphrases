...
| `plans/2026-07-02-private-lookup-hosted-reset-migration.md` | Draft/active planning. Do not execute hosted reads, writes, resets, migrations, deployments, or PR readiness changes until owner approval. | PR #152 draft, issue #151, ADR 0023, `docs/runbooks/supabase-auth-and-postgres.md`, `docs/runbooks/cloudflare-dns-and-access.md`, `docs/planning/supabase-state-ledger.md` |
