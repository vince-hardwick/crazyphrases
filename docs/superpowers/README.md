...
| `plans/2026-06-18-participant-section-multiplayer-foundation.md` | Active. Execute only after explicit owner approval of this plan and using the required execution sub-skill. | ADR 0015, `docs/superpowers/specs/2026-06-18-multiplayer-execution-redesign.md`, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md` |
