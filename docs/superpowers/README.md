...
| `plans/2026-07-06-ui-style-rationalisation.md` | Active implementation plan. Execute task-by-task using the required plan sub-skill before app code changes. | `specs/2026-07-06-ui-style-rationalisation-design.md`, `docs/product-rules.md`, `assets/site.css`, `assets/app.js`, `assets/clipboard.js`, `tests/repository-hygiene.test.mjs`, `tests/clipboard.test.mjs`, `tests/browser-smoke.test.mjs` |
...
| `specs/2026-07-06-ui-style-rationalisation-design.md` | Approved design. Implementation plan exists at `plans/2026-07-06-ui-style-rationalisation.md`; next action is to execute that plan before app code changes. | `docs/product-rules.md`, `assets/site.css`, `assets/app.js`, `assets/clipboard.js`, `tests/repository-hygiene.test.mjs`, `tests/clipboard.test.mjs`, `tests/browser-smoke.test.mjs` |
