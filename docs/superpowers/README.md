...
| `plans/2026-07-09-participant-scoped-started-game-loader.md` | Historical/completed source implementation at `ed5e0f4`. Do not treat this plan as authority for hosted migration application, deployment, or browser smoke. | GitHub issue #228, ADRs 0015, 0016, and 0027, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md`, and `docs/runbooks/cloudflare-dns-and-access.md` |
