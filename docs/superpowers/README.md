...
| `specs/2026-06-16-durable-account-profile-handle-directory-prd.md` | Published PRD provenance. Durable profile and MVP profile-management scope are complete; future avatar-upload personalisation is tracked separately. | GitHub issues #43 and #47, ADR 0011, `docs/backlog.md`, follow-ups #63 and #64 |
