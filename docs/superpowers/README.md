...
| `plans/2026-07-09-participant-scoped-started-game-loader.md` | Active. Execute for GitHub issue #228 using its confirmed public loader seams. | GitHub issue #228, ADRs 0015, 0016, and 0027, `docs/product-rules.md`, `docs/runbooks/supabase-auth-and-postgres.md` |
